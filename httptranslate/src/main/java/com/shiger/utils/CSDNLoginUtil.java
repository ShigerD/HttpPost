...
public class CSDNLoginUtil {
    ...
    List<NameValuePair> getNVPS() {
        ...
        Utils.logD(TAG,"lt=" + lt);
        Utils.logD(TAG,"execution=" + execution);
